      ...
      <article className="single-page studio-page">   
        <div className="columns-wrapper">
            ...
            <div className="right-column">
              ...
              <br />
              <p>Olitpa ensikertalainen tai kokenut tatuointien tai pigmentointien ystävä, olet lämpimästi tervetullut. Varaa aika tai tule paikan päälle piipahtamaan – tehdään yhdessä jotain upeaa. Studiolla on myös walk-in-päiviä, jolloin tatuoinnit onnistuvat ilman ajanvarausta.</p> 
              <br />
              <p>INKY 11 on suunniteltu sinua varten. Täällä tehdään kauneutta ja taidetta tunteella ja taidolla!</p>
              <br />
              ...
              <br />
              <ReadMore caption="Miten tatuointia hoidetaan?" linkTo="/tatuoinnin-hoito" />
              <br />
